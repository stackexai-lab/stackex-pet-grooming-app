...
export type Theme = {
  ...
  visuals: { surfaceDim: string; surfaceContainerLowest: string; surfaceContainerLow: string; surfaceContainer: string; surfaceContainerHigh: string; surfaceContainerHighest: string; surfaceBright: string; textTertiary: string; borderSubtle: string };
  typography: { bodyFont: string; displayFont: string; sizes: Record<string, string>; weights: Record<string, number>; headingWeight: number; buttonWeight: number };
  radii: { card: string; button: string; input: string; pill: string };
};
type Variation = { defaultPaletteId: PaletteId; baseColors: PaletteDefinition; palettes: Record<string, PaletteDefinition>; visuals: Theme['visuals']; typography: Theme['typography']; radii: Theme['radii'] };

const premium: Variation = {
  defaultPaletteId: 'sage' as PaletteId,
  baseColors: {} as PaletteDefinition,
  palettes,
  visuals: { surfaceDim: palettes.sage.background, surfaceContainerLowest: palettes.sage.surfaceSecondary, surfaceContainerLow: palettes.sage.surfaceSecondary, surfaceContainer: palettes.sage.surfaceSecondary, surfaceContainerHigh: palettes.sage.surfaceSecondary, surfaceContainerHighest: palettes.sage.border, surfaceBright: palettes.sage.surface, textTertiary: palettes.sage.textMuted, borderSubtle: palettes.sage.border },
  typography: {
...
const dark: Variation = {
  ...
  visuals: { surfaceDim: '#111317', surfaceContainerLowest: '#0c0e11', surfaceContainerLow: '#161920', surfaceContainer: '#1a1c1f', surfaceContainerHigh: '#22252a', surfaceContainerHighest: '#2c2f35', surfaceBright: '#37393d', textTertiary: '#656e82', borderSubtle: 'rgba(255,255,255,0.08)' },
